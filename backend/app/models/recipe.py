from sqlalchemy import Column, BigInteger, Integer, String, Text, TIMESTAMP, ForeignKey, Enum, JSON
...
class Recipe(Base):
    ...
    library_id = Column(Integer, ForeignKey('libraries.id', ondelete='SET NULL'), nullable=True, comment="Library ID")
    ...
    # Relationships
    library = relationship("Library", back_populates="recipes", lazy="joined")
